...
export default function PledgeCard({ pledgename, collected, target, paymentAction, bg = 'bg-light',viewConts }) {
    // const { getPledgeContributors } = usePledges()
    return (
        <Card className={bg}>
            <Card.Body>
                ...
                <Stack direction='horizontal' gap={2} className='mt-4'>
                    <Button variant="outline-primary" className='ms-auto' onClick={paymentAction}>Add Payment</Button>

                    <Button variant="outline-secondary" onClick={viewConts}>View Contributors</Button>
